...
namespace SpecFlowProject1.Pages
{
    public class Profile 
    {
        ...
        //Deleting Existing name is there any the addin new name
        ...
        public  void CheckName(IWebDriver driver)
        {
            ...
            Assert.That(Title.Text == "James Kai", "Name hasn't been added");
       ...
       public void AddDescription(IWebDriver driver)
        {           
            ...
            DescriptionTextArea.SendKeys("Welcome to my Profile");
        ...
        public void CheckDescription(IWebDriver driver)
        {
            ...
            Assert.That(Description.Text == "Welcome to my Profile", "Description not added");
        }
        ...
        public void AddSkills(IWebDriver driver)
        {
            ...
            NewSkill.SendKeys("QA Automation");
        ...
        public void CheckSkills(IWebDriver driver)
        {
            ...
            Assert.That(NewSkill.Text == "QA Automation", "Language not added");
        ...
        public void AddEducation(IWebDriver driver)
        {
            ...
            ChooseCountry.Click();
            driver.FindElement(By.XPath("//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[4]/div/div[2]/div/div/div[1]/div[2]/select/option[102]")).Click();
            ...
            ChooseTitle.Click();
            driver.FindElement(By.XPath("//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[4]/div/div[2]/div/div/div[2]/div[1]/select/option[2]")).Click();
            driver.FindElement(By.XPath("//*[@id='account-profile-section']/div/section[2]/div/div/div/div[3]/form/div[4]/div/div[2]/div/div/div[2]/div[2]/input")).SendKeys("National Diploma in Business");
            ...
            driver.FindElement(By.XPath("//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[4]/div/div[2]/div/div/div[2]/div[3]/select/option[7]")).Click();
            Thread.Sleep(200);
        ...
        public void CheckEducation(IWebDriver driver)
        {
            ...
            Assert.That(Country.Text == "New Zealand", "Country not added");
            Assert.That(University.Text == "NZTA", "University Not Added");
            Assert.That(Title.Text == "Associate", "Title not added");
            Assert.That(Degree.Text == "National Diploma in Business", "Degree Not Added");
            Assert.That(Year.Text == "2017", "Year not added");
        ...
        public void AddCertificate(IWebDriver driver)
        {
            ...
            Certification.SendKeys("C# Basics");
            ...
            Organization.SendKeys("Industry Connect");
            ...
            ChooseYear.Click();
            driver.FindElement(By.XPath("//*[@id=\"account-profile-section\"]/div/section[2]/div/div/div/div[3]/form/div[5]/div[1]/div[2]/div/div/div[2]/div[2]/select/option[2]")).Click();
            Thread.Sleep(200);
        ...
        public void CheckCertificate(IWebDriver driver)
        {
            ...
            Assert.That(Certificate.Text == "C# Basics", "Certificate not added");
            Assert.That(From.Text == "Industry Connect", "From Not Added");
